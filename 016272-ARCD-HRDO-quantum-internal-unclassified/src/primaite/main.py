...
def run(
    ...
    :param legacy_lay_down_config: True if the lay_down config file is a legacy file from PrimAITE < 2.0,
        otherwise False.
    :param previous_agent_path: zip folder containing a previously saved agent. Useful for TL because session_path loads in previous training/lay_down configs.
    """
