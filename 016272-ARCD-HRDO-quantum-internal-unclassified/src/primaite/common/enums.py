...
class AgentIdentifier(Enum):
    ...
    "The DummyAgent"
    DBM_VALUE_PPO = 7
    "The PPO agent with a DBM value network"
    DBM_POLICY_PPO = 8
    "The PPO agent with a DBM policy network"
    DBM_VALUE_POLICY_PPO = 9
    "The PPO agent with a DBM for value newtork and a DBM for policy network"
    DBM_HYPERNET_PPO = 10
    "The PPO agent with DBM Hypernetworks controlling the value network and policy network"
