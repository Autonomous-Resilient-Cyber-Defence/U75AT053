...
class PrimaiteSession:
    ...
    def __init__(
        ...
        previous_agent_path: Optional[Union[str, Path]] = "",
        agent_to_evaluate_path: Optional[Union[str, Path]] = "",
    ) -> None:
        """
        ...
        :param legacy_lay_down_config: True if the lay_down config file is a legacy file from PrimAITE < 2.0,
            otherwise False.
        :param previous_agent_path: zip folder containing a previously saved agent.
        """
        ...
        self._training_config = training_config.load(
        ...
        self.PPO_class_parameters_dict = training_config.get_ppo_parameters(self._training_config_path)
    ...
    def setup(self) -> None:
        ...
        if self._training_config.agent_framework == AgentFramework.CUSTOM:
            ...
            self._agent_session = SB3Agent(
                ...
                self.DBM_class_parameters_dict,
                self.PPO_class_parameters_dict,
                self.previous_agent_path,
                self.agent_to_evaluate_path
